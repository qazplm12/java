...
public class ArrayCopyEx {
    public static void main(String[] args) {
        ...
        // 사용법 :
        // System.arraycopy(원본배열, 원본배열의 시작index, 타겟배열, 타겟배열 시작 index, 복사할 크기);
        ...
        // Araays.copyOf() : Arrays 클래스에서 지원하는 배열 복사 메소드, 원본 배열을 그대로 복사
        // Araays.copyOfRange() : Arrays 클래스에서 지원하는 배열 복사 메소드, 원본에서 원하는 크기만큼만 복사
        // 사용법 :
