public class OperationPromotionEx {
    public static void main(String[] args) {
        ...
        byte byteValue1 = 10;
        byte byteValue2 = 20;
        // byte 타입의 변수에 저장된 데이터를 꺼내어와서 사용 시 int 타입으로 연산됨
        // 꼭 byte 타입에 저장하려면 연산 결과를 강제 타입 변환하여 저장해야함         byte byteValue3 = (byte)(byteValue1 + byteValue2);
//        byte byteValue3 = byteValue1 + byteValue2;
        ...
        char charValue1 = 'A';
        char charValue2 = 1;
        // charValue1과 charValue2의 연산 시 두변수의 값이 int 타입으로 자동 타입 변한되어 연산되고 그 결가가 int 타입의 데이터임
