...
public class InputStreamEx1 {
    public static void main(String[] args) throws Exception {
        // 부모 클래스인 InputStream이 추상 클래스이므로 자식 클래스인 FileInputStream으로 상속받아 구현해야 함
        // 부모 클래스 타입의 변수 is에 자식 클래스인 FileInputStream 객체를 생성하여 대입함
        ...
        while(true){
            ...
            // 읽어온 데이터를 char 타입으로 강제 타입 변환하여 화면 출력
